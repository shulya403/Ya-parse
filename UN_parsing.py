...
#parse = pa.Parse_El(category='ноутбук', scraper='selenium', num_outfile=1, interrupt=1).Pagination(start=1, finish=101) #Не останавливаться, ставить стопы NB 35 https://www.eldorado.ru/c/noutbuki/
