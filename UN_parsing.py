...
# oct-25 parse = pa.Parse_CL(category='ноутбук', scraper='selenium', num_outfile=0, interrupt=10).Pagination() #Следить - все ли (для rquest); selenium подрубается со второго запуска
# oct-25 parse = pa.Parse_DNS(category='ноутбук', scraper='selenium', num_outfile=1, interrupt=5).Pagination(start=15) #Следить - все ли
...
#parse = pa.Parse_DNS(category='монитор', scraper='selenium', num_outfile=2, interrupt=5).Pagination(start=53)
