...
# mar025 parse = pa.Parse_DNS(category='ноутбук', scraper='selenium', num_outfile=3, interrupt=5).Pagination(start=43) #Следить - все ли
...
# mar-25 parse = pa.Parse_DNS(category='монитор', scraper='selenium', num_outfile=0, interrupt=5).Pagination()
...
#   Pagination(vendors=[])
# mar-25 parse = pa.Parse_DNS(category='проектор', scraper='selenium', num_outfile=0, interrupt=5).Pagination()
