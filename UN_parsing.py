...
# parse-25 parse = pa.Parse_CL(category='ноутбук', scraper='selenium', num_outfile=0, interrupt=10).Pagination() #Следить - все ли (для rquest); selenium подрубается со второго запуска
# parse-25 parse = pa.Parse_DNS(category='ноутбук', scraper='selenium', num_outfile=3, interrupt=5).Pagination(start=55) #Следить - все ли
...
# Sep-25 parse = pa.Parse_DNS(category='монитор', scraper='selenium', num_outfile=4, interrupt=5).Pagination(start=51)
...
#parse = pa.Parse_Ya(category='проектор', scraper='selenium', num_outfile=0, interrupt=5).\
#   Pagination(vendors=[])
# Sep-25 parse = pa.Parse_DNS(category='проектор', scraper='selenium', num_outfile=0, interrupt=5).Pagination()
