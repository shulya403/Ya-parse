...
#parse = pa.Parse_Ya(category='ноутбук', scraper='selenium', num_outfile=3, interrupt=1).Pagination(vendors=["Alienware", "Apple", "Asus", "Dell", "Honor", "HP", "Lenovo", "MSI", "Huawei"])
...
#parse = pa.Parse_Ya(category='монитор', scraper='selenium', num_outfile=0, interrupt=1).Pagination(vendors=[])

# Mnt ["Acer","AOC", "Asus", "BenQ", "Dell", "HP", "Iiyama", "LG", "Philips", "Samsung", "Viewsonic", "Lenovo", "MSI", "NEC", "Xiaomi", "Gigabyte"]

#parse = pa.Parse_Ya(category='проектор', scraper='selenium', num_outfile=0, interrupt=1).Pagination(vendors=[])
