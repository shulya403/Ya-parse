...
#parse = pa.Parse_CL(category='ноутбук', scraper='requests', num_outfile=4, interrupt=5).Pagination(69) #Следить - все ли
...
#parse = pa.Parse_CL(category='монитор', scraper='requests', num_outfile=2 , interrupt=5).Pagination(21) #Следить - все ли
