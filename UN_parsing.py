...
# june-24 parse = pa.Parse_CL(category='ноутбук', scraper='selenium', num_outfile=0, interrupt=15).Pagination() #Следить - все ли (для rquest); selenium подрубается со второго запуска
# june-24 parse = pa.Parse_DNS(category='ноутбук', scraper='selenium', num_outfile=0, interrupt=5).Pagination() #Следить - все ли
...
# june-24 parse = pa.Parse_Ya(category='ноутбук', scraper='selenium', num_outfile=2, interrupt=2, user_id=1).\
#Pagination(vendors=["Acer", "Asus", "Dell", "Honor", "HP", "Huawei", "Lenovo", "MSI"])
# "data-auto": "snippet-price-old"
# "data-auto": "price-value"
# Nb ["Acer", "Alienware", "Apple"]

# june-24 parse = pa.Parse_CL(category='монитор', scraper='selenium', num_outfile=0, interrupt=15).Pagination() #Следить - все ли
# june-24 parse = pa.Parse_DNS(category='монитор', scraper='selenium', num_outfile=0, interrupt=10).Pagination()
...
# jun-24 parse = pa.Parse_Ya(category='монитор', scraper='selenium', num_outfile=0, interrupt=2, user_id=1).\
#     Pagination(vendors=[])
