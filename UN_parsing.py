...
#ok parse = pa.Parse_Ya(category='ноутбук', scraper='selenium', num_outfile=10, interrupt=15, user_id=1).Pagination(vendors=['Acer'])

# Nb ["Acer", "Alienware", "Apple", "Asus", "Dell", "Honor", "HP", "Lenovo", "MSI", "Huawei", "Haier", "Hiper", "Gigabyte", "Chuwi"]
...
#OK parse = pa.Parse_Ya(category='монитор', scraper='selenium', num_outfile=0, interrupt=1, user_id=1).Pagination(vendors=[])

# Mnt ["Acer","AOC", "Asus", "BenQ", "Dell", "HP", "Iiyama", "LG", "Philips", "Samsung", "Viewsonic", "Lenovo", "MSI", "NEC", "Xiaomi", "Gigabyte", "Huawei"]

#ok parse = pa.Parse_Ya(category='проектор', scraper='selenium', num_outfile=0, interrupt=1, user_id=1).Pagination(vendors=[])
# Prj []

#ok parse = pa.Parse_Ya(category='ибп', scraper='selenium', num_outfile=1, interrupt=1).Pagination(vendors=['APC'])
