...
#parse = pa.Parse_El(category='ноутбук', scraper='requests', num_outfile=2, interrupt=1).Pagination(finish=1) #Не останавливаться, ставить стопы
...
parse = pa.Parse_El(category='монитор', scraper='requests', num_outfile=1, interrupt=1).Pagination(finish=18)
