...
parse = pa.Parse_DNS(category='ноутбук', scraper='selenium', num_outfile=4, interrupt=20).Pagination(start=40) #Следить - все ли
#parse = pa.Parse_El(category='ноутбук', scraper='selenium', num_outfile=1, interrupt=1).Pagination(start=1, finish=94) #Не останавливаться, ставить стопы NB 35 https://www.eldorado.ru/c/noutbuki/
