...
#parse = pa.Parse_El(category='ноутбук', scraper='selenium', num_outfile=1, interrupt=1).Pagination(finish=59) #Не останавливаться, ставить стопы NB 35 https://www.eldorado.ru/c/noutbuki/
...
#parse = pa.Parse_El(category='монитор', scraper='selenium', num_outfile=2, interrupt=1).Pagination(start=3, finish=21) # мониторы 17 https://www.eldorado.ru/c/monitory/
