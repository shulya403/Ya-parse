...
#parse = pa.Parse_El(category='ноутбук', scraper='requests', num_outfile=1, interrupt=1).Pagination(finish=35) #Не останавливаться, ставить стопы NB 35 https://www.eldorado.ru/c/noutbuki/
...
parse = pa.Parse_El(category='монитор', scraper='requests', num_outfile=1, interrupt=1).Pagination(finish=17) # мониторы 17 https://www.eldorado.ru/c/monitory/
