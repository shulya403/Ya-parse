...
# Oct = CPN.Concat_Parse_Files('Ноутбук', M='Oct', Y=20)
# Oct.Concat_files()
...
# FileHandler = CPN.Consist_Names(category="Ноутбук", #для ноутов для yama заменить Mod_Name_restrict на просто Name
#                                 file_itr="Reports/NB_Pivot_Oct.xlsx",
#                                 M='Oct',
#                                 Y='20',
#                                 file_work_name=""
#                                 )
