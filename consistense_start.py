...
# oct25 = CPN.Concat_Parse_Files('ноутбук', M='Oct', Y=25)
# oct25.Concat_files()

# Oct_25 = CPN.Concat_Parse_Files('монитор', M='Oct', Y=25)
# Oct_25.Concat_files()
...
FileHandler = CPN.Consist_Names(category="Монитор",
                                ...
                                M='Oct',
                                Y='25',
                                file_work_name="Монитор-Concat_Prices--Oct-25--Source.xlsx")
